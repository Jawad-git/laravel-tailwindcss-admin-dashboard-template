    ...
    <div class="justify-content-center">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                {{ __('messages.Manage the restaurant') }}
            </div>
            <div class="card-body">
                <form wire:submit.prevent="update">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4 ">
                            <div class="form-group mt-4">
                                ...
                                <x-orion.form-input-multilingual :language="$lang" inputkey="name" objectName="names" />
                                <x-orion.form-error-multilingual :language="$lang" inputkey="name" objectName="names" />
                            </div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="row ">
                        <div class="col-md-12 ">
                            <div class="form-group mt-4">
                                <x-orion.scheduler-timer :weekdays="$weekdays" :activeDays="$activeDays" :startTimes="$startTimes" :endTimes="$endTimes" />
                            </div>
                        </div>
                    </div>
                    <div class="row ">
