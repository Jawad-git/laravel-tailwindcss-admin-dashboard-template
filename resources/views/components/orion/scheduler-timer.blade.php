...
<div class="row ">
    <div class=" col-md-2">
        <div class="mt-[2.25rem] flex flex-col justify-content-center align-center">
            <label class="self-center" for="{{$weekday['name'] . 'switch'}}">{{ __('messages.' . $weekday['name']) }}</label>
    ...
    <div class="col-md-5 ">
        <div class="form-group mt-4">
            <x-orion.form-label inputkey="startTimes.{{  $weekday['name'] }}">{{ __("messages.Start time" ) }}</x-orion.form-label>
    ...
    <div class="col-md-5 ">
        <div class="form-group mt-4">
            <x-orion.form-label inputkey="endTimes.{{  $weekday['name'] }}">{{ __("messages.End time" ) }}</x-orion.form-label>
